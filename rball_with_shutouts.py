...
def simNGames(n, probA, probB):
    ...
    # Returns numbers of wins for A and B
    # Returns number of shutout wins for A and B
    winsA = winsB = 0
    ...
    for i in range(n):
        ...
        if scoreA > scoreB:
            winsA = winsA + 1
            if scoreB == 0: # Check for shutout win
                shutoutsA += 1          
        else:
            winsB = winsB + 1
            if scoreA == 0: # Check for shutout win
                shutoutsB += 1
