...
def printIntro():
    ...
    print("between teams 'A' and 'B'. The abilities of")
    print("each team are indicated by a probability (a")
...
def endGame(pointsA, pointsB):
    return (pointsA >= 15 and pointsA >= pointsB + 2) or (pointsB >= 15 and pointsB >= pointsA + 2)
